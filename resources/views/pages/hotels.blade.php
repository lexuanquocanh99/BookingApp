	...
	<main id="content">
		<div class="catalog-page">
			<div class="left-side-bar">
				<div class="side-bar-search-form">
					<form action="#" style="margin: 8px">
				...
				<div class="side-bar-filters" style="border-radius: 5px; border: solid 1px #C4C4C4; margin-bottom: 32px;">
					<div class="filters-price-range" style="margin-left: 8px;">
						<h4 style="margin-top: 8px; margin-bottom: 4px;">Price Range</h4>
					...
					<div class="filters-star-rating" style="margin-top: 8px; margin-left: 8px;">
						<h4 style="margin-top: 8px; margin-bottom: 4px;">Star Rating</h4>
						<input type="checkbox" name="star-rating" value="5star">
						<label for="5star"><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon></label><br>
						<input type="checkbox" name="star-rating" value="4star">
						<label for="4star"><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon></label><br>
						<input type="checkbox" name="star-rating" value="3star">
						<label for="3star"><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon></label><br>
						<input type="checkbox" name="star-rating" value="2star">
						<label for="2star"><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon></label><br>
					</div>
					<div class="filter-amenties" style="margin-top: 8px; margin-left: 8px;">
						<h4 style="margin-top: 8px; margin-bottom: 4px;">Amenties</h4>
						<input type="checkbox" name="amenties" value="wifi">
						<label for="wifi"></label>Wifi<br>
						<input type="checkbox" name="amenties" value="shower">
						<label for="shower"></label>Shower<br>
						<input type="checkbox" name="amenties" value="telephone">
						<label for="telephone"></label>Telephone<br>
						<input type="checkbox" name="amenties" value="television">
						<label for="television"></label>Television<br>
					</div>
					<div class="filter-city" style="margin-top: 8px; margin-left: 8px; margin-bottom: 8px;">
						<h4 style="margin-top: 8px; margin-bottom: 4px;">City</h4>
						<input type="checkbox" name="city" value="london">
						<label for="london"></label>London<br>
						<input type="checkbox" name="city" value="hcm">
						<label for="hcm"></label>Ho Chi Minh<br>
						<input type="checkbox" name="city" value="ny">
						<label for="ny"></label>New York<br>
						<input type="checkbox" name="city" value="seoul">
						<label for="seoul"></label>Seoul<br>
					</div>
				</div>
			</div>
			<div class="catalog-content">
				<div class="count-found-items">
					<p style="margin-top: 0; margin-left: 16px; "><strong>1500 Hotels Found</strong></p>
				</div>
				<div class="filter-bar" style="margin-left: 16px; border-radius: 5px; margin-bottom: 8px;">
					<table width="766px" style="text-align: center;">
						<tr>
							<td style="border: solid 1px #C4C4C4; border-radius: 5px 0px 0px 5px;">
								<button style="width: 100%; height: 40px; border: none; background-color: white;">Recommend</button>
							</td>
							<td style="border: solid 1px #C4C4C4;">
								<button style="width: 100%; height: 40px; border: none; background-color: white;">Price <ion-icon name="chevron-down-outline"></ion-icon></button>
							</td>
							<td style="border: solid 1px #C4C4C4; border-radius: 0px 5px 5px 0px;">
								<button style="width: 100%; height: 40px; border: none; background-color: white;">Star <ion-icon name="chevron-down-outline"></ion-icon></button>
							</td>
						</tr>
					</table>
				</div>
				<div class="hotel-items" style="margin-left: 16px;">
				...
				<div class="pagination" style="width: 766px; height: 25px; margin-bottom: 32px; margin-left: 20px;">
					<table class="pagination-table" width="766px">
						<tr>
							<td>
...
.pagination a:last-child {
  ...
  border-bottom-right-radius: 5px;
	...
	.side-bar-search-form select,option {
		height: 30px;
		width: 226px;
